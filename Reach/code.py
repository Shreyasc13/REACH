...
def about():
    ...
    global about_frame
    about_frame = Frame (about_win, bg='blue', borderwidth=5, padx=20, pady=20)
    about_frame.grid(row=3, coloumn=20,padx=20, pady=40, sticky=N)
...
reg_btn.place(x=550,y=350)

about_btn = Button(landing_frame, text="About Us", font=("bold", 18), fg="white", bg="#2ecc72", relief=FLAT,padx=60,pady=20, command=about)
about_btn.place(x=950,y=350)

quote = Label(landing_frame, text='Welcome To Reach', fg="black" , bg="#0059b3" )
